...
from dataportal.forms import UserForm, UserProfileForm
from dataportal.forms import CategoryForm
...
def add_category(request):
    ...
    return render_to_response('dataportal/add_category.html', {'form': form}, context)
